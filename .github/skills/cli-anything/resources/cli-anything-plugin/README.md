...
- Easy installation: `uv tool install cli-anything-<software>`
...
```bash
uv tool install cli-anything-<software>
...
- Reinstall: `uv tool uninstall cli-anything-<software>; uv tool install cli-anything-<software>`
