...
**Product Requirements Document (PRD) v1.40**
...
- **Living Milestone Decision Briefing Packet** is the primary accumulating artifact and opportunity roadmap for MVP; it should continuously gather reviewed answers, assumptions, gaps, risks, recommendations, source support, and readiness signals from the assisted capture loop so the user can make the appropriate Milestone 1, 2, 3, or 4 decision.
