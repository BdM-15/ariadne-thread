...
- A **SAM.gov Enrichment Profile** can recommend Firecrawl or web enrichment when official SAM.gov signals are ambiguous, stale, renamed, or incomplete, but Firecrawl remains a separate future capability until selected through its own documented slice.
...
- **Web Enrichment Support** can complement **SAM.gov Opportunity Discovery**, but web results remain separate source evidence or capability outputs rather than replacing official SAM.gov records.
