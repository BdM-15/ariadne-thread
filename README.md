...
The product source of truth is [PRD.md](PRD.md). Phase 0 focuses on developer skills, architecture foundations, and the command center shell before application features are built.
