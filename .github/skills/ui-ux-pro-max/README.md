...
> Note: Ariadne vendors this skill under `.github/skills/` for VS Code.

```bash
# Generate design system with ASCII output
python3 .github/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness" --design-system -p "Serenity Spa"

# Generate with Markdown output
python3 .github/skills/ui-ux-pro-max/scripts/search.py "fintech banking" --design-system -f markdown

# Domain-specific search
python3 .github/skills/ui-ux-pro-max/scripts/search.py "glassmorphism" --domain style
python3 .github/skills/ui-ux-pro-max/scripts/search.py "elegant serif" --domain typography
python3 .github/skills/ui-ux-pro-max/scripts/search.py "dashboard" --domain chart

# Stack-specific guidelines
python3 .github/skills/ui-ux-pro-max/scripts/search.py "form validation" --stack react
python3 .github/skills/ui-ux-pro-max/scripts/search.py "responsive layout" --stack html-tailwind
```
...
python3 .github/skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp"

# Also create a page-specific override file
python3 .github/skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp" --page "dashboard"
```
