...
**Product Requirements Document (PRD) v1.53**
...
- **Living Packet Live View** is the user-facing visual packet workspace built from the Packet Field Action Matrix and Packet Field Answers. It should show packet sections as a polished decision-brief surface, connect each visible section to required data elements, show answer/gap/source/review state, and expose the actions already taken or still recommended to fill each element.
